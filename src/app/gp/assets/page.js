    ...
    <>
      ...
      <div className="p-6 bg-gray-100 min-h-screen">
        <div className="container mx-auto">
          ...
          <div className="mb-6">
            <Link href="/gp/assets/add-new" className="btn btn-primary">
              Add New Asset
            </Link>
          </div>
                  ...
                  {assets.map((asset) => (
                    <tr key={asset.id}>
                      ...
                      <td className="border px-4 py-2">
                        <Link href={`/gp/assets/view-details/${asset.id}`} className="text-blue-500 hover:underline mr-2">
                          <FaBox />
                        </Link>
                        <Link href={`/gp/assets/edit/${asset.id}`} className="text-yellow-500 hover:underline mr-2">
                          <FaEdit />
                        </Link>

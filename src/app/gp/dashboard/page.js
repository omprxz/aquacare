        ...
        <div className="container mx-auto">
          ...
          <div className="mb-8">
            ...
            <div className="flex flex-wrap gap-4 justify-around">
              <Link href="/gp/assets" className="btn btn-primary w-[45%]">
                Manage Assets
              </Link>
              <Link href="/gp/consumables" className="btn btn-warning w-[45%]">
                Inventory Management
              </Link>
              <Link href="/gp/billing" className="btn btn-secondary w-[45%]">
                Generate Bills
              </Link>
              <Link href="/gp/payments" className="btn btn-info w-[45%]">
                Payment Tracking
              </Link>
              <Link href="/gp/settings" className="btn btn-outline w-[45%]">
                GP Settings
              </Link>
            </div>
          </div>

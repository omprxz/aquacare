...
const LoginPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (activeTab === 'phed') {
      ...
      router.push('/prototype/phed/dashboard');
    } else if (activeTab === 'gp') {
      localStorage.setItem('auth', '2');
      router.push('/prototype/gp/dashboard');
    } else if (activeTab === 'consumer') {
      localStorage.setItem('auth', '3');
      router.push('/prototype/consumer/dashboard');
    }
  };
          ...
          {activeTab === 'consumer' && (
            <>
              ...
              <div className="mb-4 text-right">
                <Link href="/prototype/auth/register" className="text-sm" style={{ color: '#3b82f6' }}>
                  New Consumer?
                </Link>
              </div>
            </>

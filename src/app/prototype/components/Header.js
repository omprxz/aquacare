...
const Header = () => {
  ...
  const handleSignOut = () => {
    ...
    router.push('/prototype/auth/login');
  };

  const getDashboardLink = () => {
    if (auth === '1') return '/prototype/phed/dashboard';
    if (auth === '2') return '/prototype/gp/dashboard';
    if (auth === '3') return '/prototype/consumer/dashboard';
    return '/';
  };

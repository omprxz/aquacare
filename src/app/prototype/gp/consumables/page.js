    ...
    <>
      ...
      <div className="p-6 bg-gray-100 min-h-screen">
        <div className="container mx-auto">
          ...
          <div className="mb-6">
            <Link href="/prototype/gp/consumables/add-new" className="btn btn-primary">
              Add New Consumable
            </Link>
          </div>
                  ...
                  {consumables.map((item) => (
                    <tr key={item.id}>
                      ...
                      <td className="border px-4 py-2">
                        <Link href={`/prototype/gp/consumables/view-details/${item.id}`} className="text-blue-500 hover:underline mr-2">
                          <FaBox />
                        </Link>
                        <Link href={`/prototype/gp/consumables/edit/${item.id}`} className="text-yellow-500 hover:underline mr-2">
                          <FaEdit />
                        </Link>

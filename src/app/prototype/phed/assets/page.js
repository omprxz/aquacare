    ...
    <>
      ...
      <div className="p-6 bg-gray-100 min-h-screen">
        <div className="container mx-auto">
          ...
          <div className="mb-6">
            <Link href="/prototype/phed/assets/add" className="btn btn-success">
              Add New Asset
            </Link>
          </div>
                  ...
                  {assets.map((asset) => (
                    <tr key={asset.id}>
                      ...
                      <td className="border px-4 py-2 flex space-x-2">
                        <Link href={`/prototype/phed/assets/${asset.id}`} className="text-blue-500 hover:underline">
                          <FaEye className="inline mr-1" /> View
                        </Link>
                        <Link href={`/prototype/phed/assets/${asset.id}/edit`} className="text-yellow-500 hover:underline">

...
import Footer from '@/app/prototype/components/Footer';
    ...
    <div className="flex flex-col min-h-screen bg-gray-100 text-gray-900">
      ...
      <section className="hero min-h-[60vh] bg-white flex items-center justify-center shadow-md">
        <div className="container mx-auto text-center px-6 py-12">
          <h1 className="text-4xl font-semibold mb-4">AquaCare (Prototype)</h1>
          ...
          <Link href="/prototype/auth/login">
            <button className="btn btn-outline px-6 py-2 text-lg font-medium rounded-md border-gray-500 text-gray-800">
              Get Started
            </button>
          </Link>
        </div>

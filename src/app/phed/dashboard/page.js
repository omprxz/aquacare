        ...
        <div className="container mx-auto">
          ...
          <div className="mb-8">
            ...
            <div className="flex flex-wrap gap-4 justify-around">
              <Link href="/phed/assets" className="btn btn-primary w-[45%]">
                Manage Assets
              </Link>
              <Link href="/phed/assets/add" className="btn btn-success w-[45%]">
                <FaPlus /> Add New Asset
              </Link>
              <Link href="/phed/issues" className="btn btn-warning w-[45%]">
                View Issues
              </Link>
              <Link href="/phed/reports" className="btn btn-secondary w-[45%]">
                Generate Reports
              </Link>
              <Link href="/phed/maintenance" className="btn btn-info w-[45%]">
                Maintenance History
              </Link>
              <Link href="/phed/settings" className="btn btn-outline w-[45%]">
                PHED Settings
              </Link>
            </div>
          </div>
